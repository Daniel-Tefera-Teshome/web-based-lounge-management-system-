...
<html>
	<head>
		<meta charset = "UTF-8">
		<meta charset = "UTF-8">
		<title> Register NCS </title>
		<link href="css1.css" type="text/css" rel="stylesheet">
		<script type="text/javascript" src="NullValidation.js"></script>
...
<table align = "right">
		...
		<table align = "left">
		  ...
		  <form action="" onsubmit="return validate_form(this);" method="POST">
			...
			<tr>
				...
				<td> <input type = "text" id = "Email" name = "email" placeholder = "Email here"> </td>
			</tr>
			<tr>
	...
	<?php 
	   ...
	   {
		  //echo"table NCStudent created successfully";
	   }else{
	  ...
	  if(isset($_POST['Register']))
	  {
		 ...
		 $insert = "INSERT INTO NCStudent 
		 (FName,LName,CustID,CustTel,Age,Address,Email,Sex)
		            VALUES ('{$_POST['fname']}' , '{$_POST['lname']}' ,
					'{$_POST['custId']}' , '{$_POST['custTel']}' , 
					'{$_POST['age']}' , '{$_POST['address']}' ,
					'{$_POST['email']}' , '{$_POST['sex']}')";
				if(mysqli_query($dbc,$insert))
				{
					
					echo'<script type="text/javascript">
						alert("The data in this id is sucessfully recorded ")
						</script>';
				}
				else{
					echo'<script type="text/javascript">
						alert("error do not inserted !!! ")
