...
<html>
	...
	<body bgcolor = "RosyBrown">
		...
		<form action="" method="post">
			<tr>
				<th colspan = "2"> <b> Enter the ID that you want to Search then Press Search </b> </th>
			</tr>
			<tr>
				<td> <label for "Address"> Address : </label> </td>
				<td> <input type = "text" id = "Address" name = "id" placeholder = "ID here" required/> </td>
			</tr>
			<tr>
		...
		<?php
				...
				{
				$select = "SELECT * FROM NCStudent WHERE CustID = '{$_POST['id']}'";
				...
				while($row=mysqli_fetch_array($result)){
					...
					echo'<script>
							alert("Here is the Selected data") 
						 </script>'
					;   
