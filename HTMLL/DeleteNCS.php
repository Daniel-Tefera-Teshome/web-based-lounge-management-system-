...
<html>
	...
	<body bgcolor = "RosyBrown">
		...
		<form action="" method="post">
			<tr>
				<th colspan = "2"> <b> Enter the ID that you want to Delete then Press delete</b> </th>
			</tr>
			<tr>
				<td> <label for "ID"> ID : </label> </td>
				<td> <input type = "text" name = "id" placeholder = "ID here" required/> </td>
			</tr>
			<tr>
	  ...
	  {
		 $delete = "DELETE FROM NCStudent  		 
					 WHERE CustID = '{$_POST['id']}'";
				if(mysqli_query($dbc,$delete))
				{
					
					echo'<script type="text/javascript">
						alert("The data in this id is sucessfully Deleted ")
						</script>';
				}
				else{
					echo'<script type="text/javascript">
						alert("error do not do not !!! ")
						</script>';
				}
